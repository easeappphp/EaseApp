...
class Kernel
{
    ...
    public $middleware = [
		...
		\EaseAppPHP\Http\Middleware\EARouterMiddleware::class,
    ];

//$this->middlewarePipeQueue->pipe(new \EaseAppPHP\Http\Middleware\EARouterMiddleware($this->eaRouterinstance));
